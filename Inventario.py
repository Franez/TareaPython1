...
def main():
    ...
    while True:
        ...
        if opcion == "1":
            ...
            # Generar el reporte antes de acceder a sus claves
            reporte = generar_reporte()  # Asegúrate de que esta función devuelva el reporte correcto
            ...
            if productos_bajo_stock:
                print("\n**ALERTA** : Los siguientes productos estan bajos de stock -> ", ", ".join(productos_bajo_stock))
